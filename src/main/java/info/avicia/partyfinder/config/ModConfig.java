package info.avicia.partyfinder.config;
...
public class ModConfig {
    ...
    private static final String CONFIG_FILE = "avicia-pfinder.json";
    ...
    public static ModConfig load() {
        ...
        if (Files.exists(configPath)) {
            try {
                ...
                PartyFinderMod.LOGGER.error("Failed to load config, using defaults.", e);
            }
        }
    ...
    public void save() {
        ...
        try {
            ...
            PartyFinderMod.LOGGER.error("Failed to save config.", e);
        }
    }
}
